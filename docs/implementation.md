...
当前已有 D1 编译端口、校验和首个确定性编译器；完整 instruction/tool/delegation 投影与双射验证尚未实现。
...
```bash
npm run check   # 本机 0.1.1-rc.2 安装基线：typecheck + 157 项测试 + build
